...
using MvcAspCore.Models.Enums;

namespace MvcAspCore.Data
{
    public class SeedingService
    {
        private MvcAspCoreContext _context;

        public SeedingService(MvcAspCoreContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "magreen@gmail.com", new DateTime(1984, 5, 30), 1500.0, d2);
            Seller s3 = new Seller(3, "Mano Brown", "mano@gmail.com", new DateTime(1980, 7, 21), 1200.0, d1);
            Seller s4 = new Seller(4, "Marta Alves", "marta@gmail.com", new DateTime(1986, 6, 20), 1600.0, d3);
            Seller s5 = new Seller(5, "Bob Esponja", "bobesponja@gmail.com", new DateTime(1995, 8, 21), 1100.0, d4);
            Seller s6 = new Seller(6, "Joana Dark", "dark@gmail.com", new DateTime(1974, 5, 10), 1500.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s1);
            SalesRecord r2 = new SalesRecord(2, new DateTime(2018, 09, 4), 7000.0, SaleStatus.Billed, s5);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2019, 01, 13), 4000.0, SaleStatus.Canceled, s4);
            ...
            SalesRecord r8 = new SalesRecord(8, new DateTime(2019, 01, 11), 4000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r13 = new SalesRecord(13, new DateTime(2019, 01, 29), 10000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r31 = new SalesRecord(31, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s1);
